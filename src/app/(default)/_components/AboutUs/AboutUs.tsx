          ...
          <FlexContainer width="inherit" flexDirection="column" borderWidth="m" borderRadius="m" paddingSize="s">
            <FlexContainer flexDirection="column" gapSize="m" justifyContent="flex-start" marginBottom="m">
              ...
              <Text
                fontWeight="light"
                fontSize="xl"
                text="Transforming every layer of technology, from foundational infrastructure to user-friendly interfaces, creating powerful and reliable solutions that drive innovation."
              />
            </FlexContainer>
            <FlexContainer flexDirection="row" responsiveFlexDirection="column" gapSize="s">
              <SummaryCard
                svg={<WebDevSVG style={{ height: '3.5rem', width: '3.5rem' }} />}
                header="Web"
              ...
              <SummaryCard
                header="Cloud"
                svg={<CloudSVG style={{ height: '3.5rem', width: '3.5rem' }} />}
              ...
              <SummaryCard
                header="Kubernetes"
                svg={<KubernetesSVG style={{ height: '3.5rem', width: '3.5rem' }} />}
  ...
  return (
    <SummaryCardContainer>
      <FlexContainer height="100%" paddingSize="m" borderWidth="s" borderRadius="m">
        ...
        <Text fontWeight="medium" fontSize="xl" text={header} />
        <Text fontWeight="light" fontSize="l" text={text} />
      </FlexContainer>
    </SummaryCardContainer>
  )
}
...
const SummaryCardContainer = ({ children }: { children: React.ReactNode }) => {
  return <div className={styles.summaryCardContainer}>{children}</div>
}

const SvgContainer = ({ children }: { children: React.ReactNode }) => {
  return <div className={styles.svgContainer}>{children}</div>
}
