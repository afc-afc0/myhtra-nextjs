...
export default function Home() {
  ...
  const { loading, updatePostRequest, onChangeLexical, handleUpdate, isSubmittable, handleUpdatePostRequestChange } = useUpdatePost({ postId: postId, initialPost: post })
          ...
          <FlexContainer width='inherit' height='auto' paddingSize='s' gapSize='s'>
            <FlexContainer width='100%' flexDirection='row' gapSize='s'>
              <FlexContainer width='25%'>
                ...
                <Input id='inputText' value={updatePostRequest?.name} onChange={(e) => handleUpdatePostRequestChange({ name: e.target.value })} /> 
              </FlexContainer>
              <FlexContainer width='25%'>
              ...
              <FlexContainer width='25%'>
                ...
                <Checkbox id='isPublished' checked={updatePostRequest?.isPublished} onCheckedChange={(value) => handleUpdatePostRequestChange({ isPublished: value === true })} />
              </FlexContainer>
            </FlexContainer>
